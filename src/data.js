...
// import isa from './assets/ArtistsPictures/isabelle2.jpg';
...
import audio01 from "./assets/Audio/dunkleecken_audio_6.mp3";
import audio02 from "./assets/Audio/dunkleecken_audio_13.mp3";
import audio03 from "./assets/Audio/dunkleecken_audio_11.mp4";
import audio04 from "./assets/Audio/dunkleecken_audio_5.m4a";
import audio05 from "./assets/Audio/dunkleecken_audio_12.mp4";
import audio06 from "./assets/Audio/dunkleecken_audio_1.mp4";
import audio07 from "./assets/Audio/dunkleecken_audio_10.m4a";
import audio08 from "./assets/Audio/dunkleecken_audio_4.mp4";
import audio09 from "./assets/Audio/dunkleecken_audio_9.m4a";
import audio10 from "./assets/Audio/dunkleecken_audio_2.m4a";
import audio11 from "./assets/Audio/dunkleecken_audio_14.m4a";
import audio12 from "./assets/Audio/dunkleecken_audio_17.m4a";
import audio13 from "./assets/Audio/dunkleecken_audio_16.mp3";
import audio14 from "./assets/Audio/dunkleecken_audio_15.m4a";
...
export const audioData = [
  {
    ...
    description: (
      <>
        Meine Depression würde ich beschreiben als Verzweiflung, Dunkelheit,
        Sinnlosigkeit, fehlen an Trage und Kraft. Es gab mehrere Faktoren, die
        meine Depression begünstigt haben, irgendwann hat sie dann begonnen.
        <br />
        <br />
        Bei mir selbst war es vielleicht nicht so sehr ein Tabu, als fehle mir
        die Hilflosigkeit, in meiner Umgebung sicher aber auch ein Tabu. Das
        Umfeld hat mit Unverständlichkeit reagiert.
        <br />
        <br />
        Die Krankheit bin ich selbst eher etwas später angegangen. Sie hat sich
        inzwischen, ganz sicher, deutlich gebessert. Es besteht weiterhin eine
        Grundstellung, die ich vielleicht als Demut bezeichnen würde, und
        zeitweise kommt eine Traurigkeit über ganz banale Sachen dazu. Es war im
        Wörtlichem Sinn notwendig, sich der Krankheit zu stellen, und etwas
        dagegen zu tun.
        <br />
        <br />
        ...
        notwendig. Ohne hätte ich es nicht geschafft. Umfeld war auch die
        Psychotherapie. Enorm wichtig ist das Verständnis, das ein Erkrankter
        von der Umgebung bräuchte, die es aber kaum aufbringt. Letztlich ist es
        ja so, dass man sich selber versteht.
      </>
    ),
    url: audio01,
    type: "audio/mpeg",
  },
  {
    ...
    description: (
      <>
        ...
        Ein-einhalb Jahre unter starken Depressionen gelitten, dass ich damals
        depressiv war, war mir zu der Zeit nicht bewusst. Erst als ich von der
        Krankheit geheilt worden bin hab ich erkannt, dass ich ein-einhalb Jahre
        depressiv war. Ich habe zu der Zeit gespürt, dass etwas mit meinem
        Gemütszustand anders war als bei anderen Leuten, dass mein Leben nicht
        so funktioniert hat, wie bei den anderen und doch habe ich nicht
        erkannt, dass ich krank bin. Es war so, als wär ich ein einer Blase aus
        negativen Gedanken gefangen gewesen. Dieser “Blasenzustand” ist
        irgendwann zu Normalität geworden, weil ich mich zunehmend daran
        gewöhnte und wenn irgendwas normal ist, hört man auf, es zu reflektieren
        oder es zu hinterfragen.
        <br />
        <br />
        ...
        ich bin, der zu derzeit agiert hat, sondern meine Krankheit.
        <br />
        <br />
        ...
        Vergangenheit, die bestimmt dazu beigetragen haben, dass ich depressiv
        geworden bin. Es war viel mehr die Summe der Gegebenheiten, als wie ein
        ...
        <br />
        <br />
        In diesen eineinhalb Jahren wusste ich selbst gar nicht mal, was mit mir
        ...
        gemangelt, wenn man mal den Kern begriffen hat. Dennoch finde ich, dass
        es sehr schwierig ist für Jugendliche, die unter dieser Krankheit
        leiden, sich zu informieren oder gar zu erkennen, dass sie depressiv
        sind. Deswegen plädiere ich stark für eine größere Aufklärung zu diesem
        Thema, v.a. von Schulen oder jugendorganisatorischen Einrichtungen.
        <br />
        <br />
        Da meine Familie vor mir wusste, dass ich depressiv bin, hat sich die
        Sache mit dem “Geständnis” von selbst gelegt, ich musste mich nicht
        ...
        verschiedenen Familienmitgliedern, man wird toleranter zueinander und
        verständnisvoller.
        <br />
        <br />
        Zumal würde ich mir selbst sagen: “Gut gemacht, dass du aus der
        Krankheit rausgekommen bist und mutig von dir, dass du dir Hilfe geholt
        hast, dass du in die Klinik Bad-Bachgart gegangen bist, dass du dich
        überwunden hast, dich der Krankheit zu stellen.”
        <br />
        <br />
        ...
        Sachen, die man an sich selbst eigentlich nicht sehen mag, aber wenn man
        die mal überwunden hat, dann… kann man echt gut aus der Krankheit
        rauskommen und auch sehr reif. Was ich noch meinem jüngerem “Ich” sagen
        würde - eben großes Stichwort MUT! An euch Leute da draußen: habt keine
        Angst vor nichts, es kann gar nichts schlimmes passieren.
      </>
    ),
    url: audio02,
    type: "audio/mpeg",
  },
  {
    ...
    description: (
      <>
        ...
        einem undurchschaubaren Gewirr dass eine offene Auseinandersetzung
        ...
        zerstören. Gefangen im eigenem Verhalten, wie im Traum, kommt die Nummer
        von der Stelle.
        <br />
        <br />
        Mit der Zeit wächst die Fähigkeit, von Problemen abzuwenden. Mit ihr,
        der eigene Schatten, den es zu überwinden gibt. Verhalten wird zum
        ...
        nachjagt, versinkt man im Dunkeln der eigenen Untätigkeit.
        <br />
        <br />
        ...
        nachzugeben.Ich glaube nicht, dass ich besiegt habe. Irgendwo sitzt er
        immer noch, der innere “Aufschieber”, und wartet für die Möglichkeit,
        auch rauszukommen.
        <br />
        <br />
  ...
  },
  {
    ...
    description: (
      <>
        Hallo, bei mir wurde vor dreizehn Jahren eine Psychose diagnostiziert.
        Aus meiner Sicht: ich würde es nicht als eine Diagnose oder Krankheit
        ...
        sagen kann, je höher mein Medikament dosiert und je schneller man sie
        wieder absetzt, versucht eigenständig, oder auch mit einem Psychiater,
        der sagt: “Sofort die Medikamente wieder wegnehmen”, so können auch
        Psychosen entstehen oder andere Verhaltensstörungen im Körper. Das kann
        man dann Störung nennen.
        <br />
        <br />
        Ich habe die Ausbildung zur Genesungsbegleitung von 2017 bis 2019
        gemach. Die war für mich der Auslöser, dass es mir heute relativ sehr
        gut geht, psychisch und auch körperlich. Sie war für mich gut und
        hilfreich. Sozusagen haben wir uns mit der eigenen Geschichte
        auseinandergesetzt. Die Geschichte “Recovery”, also aus der Krise, wie
        man mit Krisen umgeht, die verschiedenen Themen und Module haben mir
        gezeigt: ich bin nicht alleine, wir können etwas schaffen im
        psychatrischem System, eine Veränderung. Ich habe dazu auch gelernt, was
        ich kann: Niemand zwingt mich eine hohe Dosis zu nehmen. Ich kann da
        frei entscheiden. Es war nicht immer erlaubt frei zu entscheiden, aber
        ich habe gelernt, mich kann niemand zwingen. Ich kann, wenn ich will mit
        einer niederen Medikation umgehen, sodass ich noch mehr meinen Körper
        spüre und die Verantwortung nicht einem Psychiater ganz überlassen muss.
        Selbst die Verantwortung zu übernehmen, war für mich der Ausgang aus der
        Krise. Zu wissen, dass ich selbst über mich und meine Gesundheit
        entscheiden kann, ist für mich ein sehr wichtiges Thema geworden.
        <br />
        <br />
        Danke fürs Zuhören, und ich hoffe wir schaffen es, wir
        Genesungsbegleiter oder andere Betroffene, die noch auf dem Weg sind,
        und immer auch lernen wollen, Veränderungen zu wünschen. Ich hoffe das
        wir es alle zusammen schaffen, das Psychatrische System ein bisschen zu
        verändern und vielleicht umzugestalten. Danke.
      </>
    ),
    url: audio04,
    type: "audio/x-m4a",
  },
  {
    ...
    description: (
      <>
        Hallo, Ich bin 23 Jahre alt und bin Grafikdesigner. Das, was ich hier
        beschreiben werde, begleitet mich bereits mein ganzes Leben. Ich bin
        nämlich transgender. Das heißt, ich bin als Frau geboren, lebe also
        mittlerweile als Mann. Mir ist das aber erst vor ein paar Jahren erst
        wirklich bewusst geworden, weil ich vorher einfach keinen Begriff für
        meinen Gemütszustand hatte. Es ist ziemlich schwer, anderen zu
        beschreiben, wie man sich fühlt, wenn man selber nicht genau versteht.
        <br />
        <br />
        Dann stellt sich die Frage, wie soll ein Mensch sich in einem Geschlecht
        wohlfühlen, indem er nicht geboren wurde? Es ist eine durchaus legitime
        Frage, und meine Antwort drauf ist: ich weiß es einfach. Der einfachste
        Vergleich, der mir dazu einfällt ist: Rechts, oder Linkshänder? Woher
        weiß man zB., dass links zu schreiben für einem falsch ist? Es fühlt
        sich einfach nicht richtig an, oder? Man kann nicht richtig schreiben,
        die Schrift ist wackeliger, die Hand ist einfach unsicher. Genau dieses
        Unwohlsein empfinde ich schon seit ich denken kann, in meinem Körper. Es
        passte einfach nicht zusammen. Bis ich auf den Begriff “Transgender”
        gestoßen bin, vor 16 Jahren vergangen.
        <br />
        <br />
        In meiner ganzen Kindheit war ich ein sorgenfreies und glückliches Kind.
        Ich habe damals nicht bewusst Geschlechter getrennt. Ich war einfach
        Ich, und habe mich ausgetobt. Ich habe zwar immer die klischeehaften
        Dingen von Jungs gemacht, wie blau war meine Lieblingsfarbe, ich hatte
        immer kurze Haare, hab mich als Superman identifiziert, anstatt Barbie
        hat es Action Man gegeben, ich wollte nur Boxershorts als Unterhosen.
        Genau wie meine ganzen Kleider, die sind auch aus der Jungsabteilung
        gekommen. Irgendwann ist mir schon bewusst geworden, OK, ich bin anders,
        aber eine gute Zeit habe ich das ignoriere können, bis ich dann eben in
        die Pubertät gekommen bin. Ihr könnt euch sich sicher vorstellen, wie
        schlimm es ist, jeden abends ins Bett zu gehen und sich zu wünschen,
        durch irgend eine magische Kraft wieder als Junge aufzuwachen. Wo man
        genau weiß, das geht nicht.
        <br />
        <br />
        Der erste Schlag ins Gesicht war dann der Brustwachstum. Ich musste in
        ...
        hinauswächst - ich hoffe, man bemerkt meinen Sarkasmus, habe ich müssen
        meine Beine rasieren. Das war auch ein Punkt, der die Trennung
        erschwerte, weil ich lustigerweise total stolz auf meine blonde
        Beinbehaarung war. Der brutalste Schlag ins Gesicht waren die Kurven.
        Ich war immer ein sehr aktives Kind, schlank von Natur aus, aber
        durchaus muskulös von meiner Statur. Aber wie es auch üblich ist, nimmt
        man ungewollt einige Kilos zu. Anfangs, dank meines guten Bindegewebes,
        hat man es nicht bemerkt und ich habe es sogar cool gefunden, etwas
        schwerer zu werden. Warum? Weil ich eine Maschine sein wollte,
        sportlich, muskulös und groß. Bei ein paar Kilos ist es aber dann leider
        nicht geblieben und ich habe über die Jahre noch einiges zugenommen. Das
        Schlimme war nicht nur, dass ich weibliche Kurven bekam: je schwerer ich
        wurde, desto weiblicher sah ich auch aus.
        <br />
        <br />
        ...
        präsentiert. Ich hatte schöne lange Haare und enge Hosen. Ich habe mich
        damals als lesbisch geoutet, weil ich eben auf Frauen stehe. In dem
        Umkreis habe ich positive Erfahrungen gesammelt, habe tolle Freunde
        getroffen. Ich war eine Zeit lang so zufrieden, aber etwas hat halt doch
        nicht gepasst.
        <br />
        <br />
        Irgendwann hat mich das dann auch wieder eingeholt. Ich habe wieder
        jeden Tag darüber nachgedacht, dann habe ich auf YouTube diesen Typen
        gefunden, der ein Transgender war. Und was ist denn jetzt transgender?
        Ich habe gedacht, es gibt nur Transvestiten also Typen, die sich als
        Frauen verkleiden. Wo es halt evident ist, dass sie keine Frauen
        sind.Mich hat es total beeindruckt: der Typ da vor mir, mit flacher
        Brust, Bart, Sixpack, Haare auf Bauch und Brust. Die total männliche
        Gestalt auf dem Bildschirm war einmal eine Frau? Dann habe ich
        angefangen zu recherchieren, und irgendwie sind mir da die Augen
        geöffnet worden. Also war klar: ich bin transgender. Endlich, weiß ich,
        was mir das Leben so erschwert, was mich seit ich denken kann begleitet.
        <br />
        <br />
        Es war zwar Shit: mit sechzehn habe ich das kaum alleine durchziehen
        können, und das in Südtirol, mit Konservativen und engstirnigen Leuten!
        Bis ich tatsächlich den Schritt gewagt habe, sollten noch einige Jahre
        vergehen. Ich hatte zu viel Angst vor anderen Menschen und deren
        Meinungen gehabt. Also habe ich das wieder runtergeschluckt.
        <br />
        <br />
        Drei Jahre später, wie vermutet, hat mich das wieder eingeholt. Diese
        Mal habe ich beschlossen, es auch durchzusetzen. Ich hab mein Leben in
        die richtige Richtung lenken müssen, und das ist nur gegangen, weil ich
        mich ordentlich mit meinem Körper angestrengt habe. Ich habe mich gut
        informiert und war überrascht, das es in Südtirol tatsächlich möglich
        war. Es hat Kontakte gegeben, die mir helfen konnten, das alles ins
        Rollen zu bringen. Natürlich habe ich wieder ein Gespräch mit der Mama
        führen müssen. Es war schwer für mich, weil ich einfach nicht die
        richtigen Worte finden konnte und da meine Verwandtschaft ziemlich
        aufbrausend untereinander ist, hat sich es laut und emotional geäußert.
        Aber zum Glück habe ich die Unterstützung von meinen Elter bekommen.
        Meine Schwester haben wir vorerst nichts gesagt, weil wir bereits in der
        Vergangenheit festgestellt haben, dass sie nicht so vertraut mit
        kontroversen Themen war, bis ich in Therapie war, als ich meine erste
        Hormonspritze vor circa einem Jahr bekommen habe.
        <br />
        <br />
        Meine Schwester hat das dann auch alles erfahren, als ich das
        durchziehen wollte. Seitdem habe ich sie nicht mehr gesehen. Ich habe
        kein Wort mehr mit ihr ausgetauscht. Leider lehnt sie das total ab und
        hat lieber eine glückliche Schwester als einen glücklichen Bruder.
        Irgendwann wird sie es auch verstehen und ich werde dann auch noch da
        sein und sie mit offenen Armen empfangen.
        <br />
        <br />
        Zurzeit durchlaufe ich gerade meine Zweite Pubertät. Nur das es dieses
        Mal die Richtige ist. Die Hormonspritze mit Testosteron, die mir alle
        drei Monaten intramuskulär injiziert wird, ist zwar kein Zaubermittel,
        das mich zu einem Mann macht, aber ein bisschen fühlt es sich schon
        danach an. Ich muss ein bisschen mit der Operation nachhelfen, Brust,
        innere Geschlechtsorgane und Geschlechtsangleichung ist zwar kein muss
        für jeden, aber ich will einfach bei 100 Prozent ankommen. Ich will das
        volle Programm, nichts zwischendrin sein, denn so war ich mein ganzes
        Leben lang.
        <br />
        <br />
        ...
        mir besser. Mein Kopf wird von Tag zu Tag leichter. Es ist ein sehr
        ...
        ist es, zu sprechen. Ich würde meinem jüngerem “Ich” die Angst nehmen,
        dass es voll akzeptiert werden kann. Ich war aber mehr überrascht, wie
        offen die Leute damit umgehen. Ich würde mir sagen: “Halt durch, das ist
        begründet. Es ist nicht leicht, aber es lohnt sich, und du wirst
        ankommen. Friss es nicht in dich hinein, sondern spreche mit Menschen,
        denen du vertraust. Mach deinen Kopf selber leichter. Ich verspreche dir
        eines, es wird besser.
      </>
    ),
    url: audio05,
    type: "audio/mp4",
  },
  {
    ...
    description: (
      <>
        ...
        ich durch meine Erzählung Licht in dieses dunkle Thema bringen darf. Im
        Jahre 2003 hat mich seelische Krankheit konfrontiert. Ich fühlte mich
        mit schwachem Selbstwertgefühl, ich fühlte mich total überfordert in
        meinem Beruf, als selbstständige Frisörin, ich fühlte mich nicht mehr
        der Arbeit gewachsen. Mein Lehrmädchen wollte in den Urlaub, Samstags
        standen Hochzeitsfrisuren an. Ich fühlte mich verletzt, durch das nicht
        Anwesen sein des damaligen Freundes und der Trennung der Beziehung. Ich
        fühlte mich müde und erschöpft.
        <br />
        <br />
        Nach mehreren Wohnungswechseln und wenig Schlaf: ich fühlte mich
        verzweifelt, dass Antidepressiva erst nach zwei Wochen wirken. Heute
        kann ich sagen, dass mehrere Dinge sich angesammelt haben, die zur
        Depression führten. Arbeitsbedingt sah ich meinem Vater in der Kindheit
        wenig. Die Mutter war traurig, als mein Vater immer wieder in die
        Schweiz zur Arbeit musste. Ich war neun Jahre alt, als mein Vater an
        ...
        der Depression war die Trennung meines damaligen Freundes. Erwähnen
        möchte ich einen Zuspruch, den ich in einer schlaflosen Nacht gegeben
        habe.
        <br />
        <br /> “Lieber Jesus, was auch immer in meinem Leben passieren mag, den
        Glauben will ich nicht verlieren.”
        <br />
        <br />
        In kurzer Zeit war ich nicht im Stande mitzuteilen, wie schlecht es mir
        geht, dass ich darauf Suizid begann. Der Notruf durch die Nachbarin war
        ...
        auf REHA-Aufenthalt. Der körperliche Aufbau auf dem Rollstuhl war eine
        ...
        Hochgrebe Gottfried, eine Kreuterexpertin in diesem Team, der bin ich
        sehr dankbar. Ausgleich und Freude geben mir Musik, Tanz und wandern in
        der Natur.
        <br />
        <br />
        Heute lebe ich bewusster, genieße bewusster, ich bin sehr dankbar dafür.
        Die Liebe war und bleibt der hellste Lichtblick meines Lebens.
        Rückblickend erinnere ich mich gut, wie ich mit den Gedanken rang:
        “Welcher Mann mag mich denn jetzt noch?”Auch da stellte ich Jesus die
        Frage: “Gibt es einen Mann, der mich liebt so wie ich bin? Sogar nach
        einem Suizidfall?“
        <br />
        <br />
        ...
        wofür ich täglich dankbar und glücklich bin. Diesen Moment nutze ich, um
        ihm zu sagen: “Ich liebe dich”. Die Liebe schenkte uns einen Sohn und
        ich durfte Mami werden.
        <br />
        <br />
        ...
        an, sei es ärztliche, sei es Hilfe von einem Nächsten. Freilich, in
        meinem Leben sind Glaube, Liebe und Hoffnung. Danke für ihr zuhören.
      </>
    ),
    url: audio06,
    type: "audio/mp4",
  },
  {
    ...
    description: (
      <>
        Also, ich bin eine 20-jährige Studentin aus Südtirol, 2015 bin ich mit
        einer Bipolaren Störung diagnostiziert worden. Bipolare Störungen sind
        Stimmungsschwankungen, die sehr abrupt sind, und sich sehr stark
        abspielen. Das beste Beispiel, was ich sagen kann, ist: manchmal putze
        ich mein Zimmer, und ich bin so richtig drinnen, putze es perfekt, dass
        man fast vom Boden essen könnte. Auf einmal geht es mir nicht mehr gut,
        und ich muss mich erst ins Bett legen, weil ich auch nicht aus dem Bett
        raus kann. Dann ist eine Hälfte vom Zimmer voll sauber, und die andere
        Hälfte ist chaotisch, wie nichts Anderes.
        <br />
        <br />
        ...
        <br />
        <br />
        Viele Menschen denken auch, dass das “manische Hoch” gar nicht so
        schlimm ist, weil man fühlt sich auch gut, man hat auch manchmal einen
        kleinen Egotrip dabei, aber es ist eine sehr physisch intensive Zeit,
        auch weil man ja so viel Energie hat. Man hat so viel Lust, 10.000
        Sachen zur selben Zeit zu tun. Manische Depressionen sind auch physisch
        schwer, weil es ist auch nicht gesund, wenn man für längere Zeit einfach
        nichts tut, für seinen Körper.
        <br />
        <br />
        Im Laufe der Therapie und im Gespräch mit Freunden und anderen Menschen,
        die ebenso bipolare Störungen haben, im echten Leben sowie Online, lernt
        man immer mehr, wie man mit diesem “Switch” umgehen kann, sodass die
        Panikattacken, und Angstzustände, die man dort erlebt, einem nicht zu
        falschen Entscheidungen führen.
        <br />
        <br />
        Angefangen hat das Ganze, glaube ich, schon wenn ich geboren bin, weil
        bipolare Störungen sind genetisch vererbbar. Mein Vater hat auch eine
        ...
        denken muss, dass ich einmal im Moment sein kann. Ich glaube, man lebt
        als mental kranker Mensch sehr oft in der Vergangenheit und in der
        Zukunft. Durch Traumata und Tagesträume, dadurch zwingt man sich selbst
        in so Traumwelten, wo man total isoliert mit sich selbst ist.
        <br />
        <br />
        ...
        auch im Sinne von gesunden Bewältigungsmechanismen lernen. Ich habe eine
        Reihe an ungesunden Bewältigungsmechanismen schon durchgemacht,
        ...
        auch im Rahme von mentalen Krankheiten, das ist natürlich ein ganzer
        Weg, da macht man Fehler, man macht auch Sachen, wo man einschneidendere
        Ergebnisse haben könnte. Aber das Wichtige ist, glaube ich, dass man
        sich als mental kranker Mensch immer weder daran erinnert, dass man
        keine schlechten Intentionen hat, und das man Chancen verdient hat, ein
        qualitatives Leben zu führen. Dazu gehört natürlich auch, ein gutes
        Umfeld aufzubauen für einen selbst. Im Sinne von: “giftige Menschen
        loslassen”. Im Sinne von: Medien konsumieren, die einen glücklich
        machen. Musik hören, die einen glücklich macht.
        <br />
        <br />
        Natürlich ist es manchmal auch schwer, weil man manipulativ sein kann
        mit sich selbst, und dann geht man genau das eine Lied hören, dass einen
        so traurig macht. Aber, der Großteil des Tages oder den Großteil des
        Lebens sollte man schon mit positiven Einflüssen verbringen. Ich finde
        diese Einflüsse sollten man nicht selbst so abwerten, als wären sie
        kindisch oder irrational, solange sie keinem wehtun, und vor allem dir
        selbst nicht. Sie sind sehr wichtig, und haben einen tiefgründigen Wert.
        <br />
        <br />
        Meinem jüngeren Selbst würde ich gerne immer sagen, dass sie sich nicht
        so viel mit der Krankheit identifizieren soll, weil es ist natürlich
        wichtig, sie auch anzunehmen und zu akzeptieren, damit man aus der
        Diagnose auch etwas machen kann. Aber die Diagnose ist nur der erste
        Schritt und da darf man nicht steckenbleiben. Das ist eine Sache, die
        viel Kraft braucht, die sehr viel Selbstliebe braucht, die man dann
        lernen muss, aber es ist es so wert, und egal wo jemand gerade stecken
        sollte, ich glaube es gibt immer positive Dinge, die jeden einzelnen Tag
        für sich mitnehmen kann. Somit, ja… das war ein bisschen was von mir!
      </>
    ),
    url: audio07,
    type: "audio/x-m4a",
  },
  {
    ...
    description: (
      <>
        ...
        psychischen Krankheit leide, ergab sich bei mir ziemlich früh, nach
        einem Vorfall in meiner Kindheit. Zwei meiner Freunde wurden sexuell
        missbraucht und ich bin dem Ganzen nur entgangen, weil ich ein paar
        Sekunden zuvor von meiner Mutter eingerufen wurde, der Geburtstag meiner
        Oma stand an. Der Täter, ein sehr gut bekannter Nachbar, hat die beiden
        dann schlussendlich zerstückelt und in seinem Garten unter ganz hohem
        Gras und unter Bäumen und Büschen in Müllsäcken versteckt. An diesem Tag
        begann dann verständlicherweise das Chaos in meinem Leben. Ein auf und
        ab, ein auf und ab.
        <br />
        <br />
        ...
        Fundament neu aufzubauen, nach dem ich in der Vergangenheit ja einige
        Tiefen erlebt habe. Seit dem liegt der Fokus einzig auf mir. Auf meinem
        Dasein und auf meinen Wünschen, die ich erfüllen will.
        <br />
        <br />
        ...
        Triggerpunkte erst gar nicht wirken zu lassen, es kann aber trotzdem
        passieren, dass sich meine Laune fünf bis zwanzig Mal am Tag verändert.
        Es ist aber OK, wenn es mir mal nicht gut geht. Das ist natürlich
        ...
        <br />
        <br />
        Mir helfen verschiedene Dinge, in diesem Zustand so gut wie möglich von
        mir fernzuhalten. In allererster Linie, und das ist witzig: meine
        Arbeit. Etwas wo Menschen mir, 100 Prozent vertrauen müssen. Kunst,
        Musik und mein Hund.
        <br />
        <br />
        Ich lasse es zu, wenn es mir nicht OK geht. Auch das muss man lernen.
        Alles in Allem geht es bergauf, ich bin nicht geheilt… noch nicht! Es
        wird von Tag zu Tag besser. Rücktritte sind vollkommen OK, gehören dazu
        und machen mich mittlerweile stark. Das hätte ich meinem jüngerem “Ich”
        auch mit auf den Weg gegeben. Nichts ist so stark, dass du es nicht
        überstehst.
        <br />
        <br />
  ...
  },
  {
    ...
    description: (
      <>
        Ich würde es wie einen Käfig nennen, den man sich selbst bildet. Eine
        Regungslosigkeit und Bewegungslosigkeit. Man sieht nur noch negative
        Dinge und positive Dinge werden gar nicht mehr erkannt, scheinen
        unsichtbar. Auch wenn irgendetwas Positives passiert, ist es nicht der
        Mut, der die negativen Dinge aufheben kann. Man hat keinen Antrieb, man
        hat Lust auf Nichts, generell die Lebensfreude fehlt einem. Und die
        generell Freude an irgendetwas überhaupt… Ich würde es wie einen
        selbstgemachte Käfig darstellen. Wie eine Kobra, die einem schlingt und
        keine Bewegung mehr zulässt. Ich finde es hat auch Ähnlichkeiten mit
        einer sehr, sehr starken Melancholie. Das, auf was ich immer mehr
        fokussiert war, war das, was schlecht ist und nicht das, was gut ist.
        <br />
        <br />
        Und auch wenn irgendetwas Positives passiert, ist es nicht der Mut, der
        die negativen Dinge aufheben kann. Man hat keinen Antrieb, man hat Lust
        auf nichts, generell die Lebensfreude fehlt einem. Und die generell
        Freude an irgendetwas überhaupt…
        <br />
        <br />
        Ich würde es wie einen selbstgemachte Käfig darstellen. Wie eine Kobra,
        die einem schlingt und keine Bewegung mehr zulässt. Ich finde es hat
        auch Ähnlichkeiten mit einer sehr, sehr starken Melancholie. Das, auf
        was ich immer mehr fokussiert war, war das, was schlecht ist und nicht
        das, was gut ist. Bei mir ist es so, dass es sehr viel mit meiner
        Selbstwahrnehmung, mit meinem Selbstbewusstsein zu tun hat und hatte.
        Dass es sich immer mehr gesteigert hat. Der Beginn davon war vor drei
        Jahren, als ich die ersten Panikattacken hatte und ich nicht mehr wusste
        was ich richtig und was ich falsch machte und was ich überhaupt machte.
        Meine Vorstellung war mehr darauf fokussiert besser zu werden, meine
        Fehler zu finden. Ich gab den Dingen, die ich falsch machte, einen sehr
        hohen Stellenwert. Bis ich dann auch schlussendlich nach Berlin gezogen
        bin, denn als meine Panikattacken begannen war ich zuhause in Südtirol
        und bin vier Mal ins Krankenhaus gefahren, da ich dachte ich sterbe. Ich
        dachte ständig, dass ich irgendeine Krankheit habe die unheilbar ist,
        und ich einen Herzinfarkt bekomme, oder an anderen Krankheiten sterben
        werde.
        <br />
        <br />
        Das wurde nur ausgelöst durch mein eigenes Verschulden, da ich nur noch
        Fehler an mir gesucht habe. Fehler, die mich zu dem brachten. Mir konnte
        auch keiner sagen, was es wirklich ist. Nach einem Jahr in Berlin habe
        ich herausgefunden, dass es Panikattacken waren. Ich habe gemerkt, dass
        ich Unterstützung von Psychologen und Menschen brauche, habe auch
        ...
        inneren Gedanken und Dämonen äußern konnten. Ich habe auch gelernt, dass
        es ich es äußern muss, da es mir gut tut und meinem Kopf und meinen
        Gedanken hilft.
        <br />
        <br />
        Es war wie ein Teufelskreis, oder eine Teufelsspirale, die immer weiter
        nach unten ging und auch immer alle zwei Wochen gekommen ist und ein Maß
        angenommen hat, dass mir viel Energie und Lebensqualität gestohlen hat.
        Eigentlich konnte ich nichts mehr schon empfand, alles war nur schwer
        für mich. Für mich ist sehr wichtig, darüber zu sprechen. Früher war es
        vielleicht, ich würde nicht sagen dass es ein Tabuthema war, es war mir
        einfach zu peinlich, darüber zu sprechen, da ich schon immer eine Person
        war, die viele Gefühle hatte und die auch erst vor kurzem gelernt habe,
        damit umzugehen oder auch lerne, damit umzugehen, da ich sie auch
        rauslasse und darüber spreche.” Andere Menschen können die selben
        Gedankengänge haben, oder auch andere Gedankengänge weshalb ich mit
        ihnen spreche, somit finde ich auch einen anderen Blickwinkel zum Thema.
        Das waren auch Psychologen. Beim Psychologen selbst war es so, dass wir
        herausgefunden dass es ganz viel mit Angst vor Bewertung zu tun hat,
        einfach.
        <br />
        <br />
        Nicht gut genug zu sein, aber nicht nur für andere Menschen, sondern vor
        allem für sich selbst. Ich habe auch gemerkt, projiziere sehr viel auf
        mich und andere, das zieht mich runter. Ich habe angefangen, mit
        ...
        Ich würde mir selbst, was raten, wenn ich mir was sagen könnte: und
        zwar, dass ich nicht alles so ernst nehmen soll. Und dass ich auch nicht
        alles auf mich selbst projizieren soll, um viel mehr Zeit für mich
        selbst zu haben. Auf mich stolz zu sein. Positives zuzulassen. Ich
        glaube, dass ich auch für mich herausgefunden habe, dass so ein Kampf
        nie fertig ist. Es ist eine ganze Lebensaufgabe, glücklich zu sein und
        sich nicht diesen Ängsten, Gedanken, diesem Teufelskreis hinzugeben.
        Wobei es auch OK ist, seine Tiefen zu haben. Ohne Tiefen, kann man auch
        nicht das Positive sehen, dann kann ma auch nicht voranschreiten. Ich
        glaube auch, dass man sehr viel daraus lernt. Ich finde, ich hab in den
        letzen drei Jahren sehr viel daraus gelernt. Ich möchte das auch anderen
        mitgeben, und ich liebe es auch, darüber zu sprechen, mit anderen
        Leuten, da ich es sehr wichtig finde. Diese Gedankengänge werden nicht
        besprochen. Es ist einfach immer nur mehr, mehr, mehr und nicht einmal
        genug ist.
        <br />
        <br />
        Es muss offener damit umgegangen werden, und einfacher zugänglich
        gemacht. Man soll über sich lachen. Man sollte auch über seine Fehler
        lachen.
      </>
    ),
    url: audio09,
  ...
  },
  {
    ...
    description: (
      <>
        ...
        Panikattacken oder einfach Phasen, wo ich mehr “down” bin, würde ich
        sagen. Das äußert sich so ein bisschen in Wutausbrüchen zum Beispiel, wo
        ich mich selber auch teilweise schlage, ja… ist eher so mit der Faust
        aufs Bein hauen, oder mit der Faust gegen den Kopf schlagen, aber es
        geht nicht so weit wie Ritzen, oder sowas. Wegen den Außbrüchen habe ich
        irgendwie auch Angst, andere zu verletzen, wodurch das auch meistens
        kommt, z.B. ich komme nicht damit klar, wenn ich etwas falsch gemacht
        habe, und die andere Person, worum es auch geht, Zeit für sich braucht,
        dann komme ich nicht damit klar. Also ich bin ein Mensch, der immer
        darüber reden muss, und wenn jemand dann von mir wegläuft oder einfach
        Zeit braucht dann mache ich mit totale Vorwürfe und gerate in eine Art
        Panik. Ich denk dann immer gleich, dass ich das Problem bin, dass ich
        alles falsch gemacht habe und will mich ein bisschen dafür bestrafen,
        glaube ich? Dann kommt es halt zu diesem Schlagen, was auf jeden Fall
        nicht gut ist und woran ich auch arbeite.
        <br />
        <br />
        ...
        angefangen, ich weiß z.B., dass mein Vater auch Wutausbrüche hat und ich
        auch schon in der Kindheit nicht damit umgehen konnte wenn mir jemand
        nicht zugehört hat. Ich glaube, bei uns in der Familie war es ganz oft
        so, dass mein Vater mit anderen Sachen beschäftigt war und so getan hat,
        als wenn er zuhörte, aber natürlich hat ma das gemerkt, und das merke
        ich auch heutzutage noch, dass ich einfach wütend werde wenn mir jemand
        nicht wirklich zuhört, und ich die Aufmerksamkeit dadurch nicht bekomme.
        Das artet dann manchmal genauso aus.
        <br />
        <br />
        ...
        Person sehr gefallen, und sie nicht verletzen möchte. Dadurch
        unterdrücke ich aber meine Gefühle, was daran ausartet, dass ich sehr
        wütend werde, weil ich einfach keine Lust habe, auf das, zu dem ich “ja”
        gesagt habe. Es ist so ein kleiner Kreislauf. Und ich meine, ich sage
        immer “ich glaube”, weil ich es auch nicht genau weiß.
        <br />
        <br />
        Also ich meine, ich habe schon früher eine Therapie gemacht, und muss
        übrigens sagen, dass ich auch schwul bin, das, glaube ich, mein ganzes
        Leben am Anfang schwerer gemacht hat, mich auch selber zu akzeptieren.
        Aber seit dem ich eigentlich damit ok bin, und mit mir im Reinen, ist
        das auch alles viel besser. Ich bin auch sehr froh, dass meine Familie
        zB. das akzeptiert.
        <br />
        <br />
        Ich muss sagen, dass ich meine “mentale Erkrankung” niemals oder..ich
        weiß ja nicht, ob ich “Erkrankung” sagen würde. Ich glaube wir haben
        halt alle so ein paar Macken, mit denen wir einfach lernen müssen, damit
        umzugehen. Ich muss schon sagen, finde ich, dass es eigentlich nicht ein
        “Tabuthema” ist, oder dass es nicht so empfunden wird. Ich meine klar,
        hat man manchmal so das Gefühl. Aber ich bin ein Mensch, der das sehr
        ...
        aus, von wegen: “Ich habe keine Lust mehr aufs Leben.” Oder ich denke
        halt darüber nach, wie man es machen könnte, aber auch nicht so stark.
        Ich glaube, meine Freunde wissen, dass es nicht so stark ist, aber ich
        kann mir vorstellen, dass manche, wenn die es hören, für die kann es
        schon sehr krass wirken. Und das ist, glaube ich aber auch so ein Schrei
        nach Aufmerksamkeit. Das weiß ich aber nicht so genau.
        <br />
        <br />
        Ich meinte schon vorhin, dass ich auch schon in Therapie war, und ich
        kann es auch wirklich empfehlen. Ich meine ich war einmal, als ich auf
        die Schule gegangen bin, damals beim Therapeuten, das hat mir schon viel
        gebracht. Einerseits, einfach um mich zu akzeptieren, so wie ich bin.
        <br />
        <br />
        Dann bin ich aber in eine andere Stadt gezogen, und habe erstmal keine
        Therapie gemacht, hab dann, aber irgendwann wieder eine Neue angefangen.
        Ich muss sagen, man sollte auf jeden Fall versuchen, sich Zeit dafür zu
        nehmen, und sich auch die Zeit zu nehmen, den richtigen Therapeuten zu
        ...
        diese Therapie einzulassen, weshalb ich sie auch abgebrochen habe.
        <br />
        <br />
        Im Moment komme ich auch sehr gut mit mir selber klar. Ich meine ich
        habe meinen Freund, der hilft mir auch sehr viel damit, und ich glaube
        das Wichtigste ist, einfach mit Leuten auch darüber zu reden. Das nicht
        für sich zu behalten. Immer an sich selber arbeiten, an sich auch
        glauben!
        <br />
        <br />
        Ich glaube einfach jeder Mensch ist perfekt eigentlich so wie er ist,
        natürlich hat er seine Macken, mit denen man aber umgehen muss, aber man
        sollte sich nicht dafür hassen. Man sollte seine Macken vielleicht so
        ein bisschen lieben lernen und einfach versuchen, damit umzugehen.
      </>
    ),
    url: audio10,
    type: "audio/x-m4a",
  ...
  },
  {
    ...
    description: (
      <>
        ...
        per fare meno. Peró non é così: una persona ADHD, sopratutto a scuola,
        fa molta fatica a stare attenta, si stanca subito. Non si riesce a stare
        seduti, ci si vuole muovere, avere la libertà e Come adesso, che c’é il
        virus, dove proprio tutti vogliono uscire. Tantissime persone vogliono
        uscire. Fare un giro, vedere la ragazza, il fidanzato, viaggiare, andare
        in bici, fare sesso, sport, lavorare, andare al cinema, andare a teatro.
        Ecco: a scuola, l’esigenza di fare qualcosa, é ugualmente come una
        persona che ha l’ADHD. Ed é proprio per questo che durante questa
        quarantena di quasi due mesi, sono calmo. Io questa situazione la
        conosco. Vi ho detto che noi ADHD non siamo in grado di stare attenti,
        siamo più aggressivi, impulsivi, emozionali. Vi dico la verità…
        Sinceramente, non c’é un modo per combattere, bisogna vivere con questa
        malattia. Peró, bisogna anche vederlo come dono. Di questo ve ne parlerò
        dopo. Comunque, non preoccupatevi. Sono delle ottime notizie. Torniamo
        un passo in dietro. Questo disturbo non é che l’ho notato io. A scuola
        non andavo mai, mai, mai bene. Mai bene. Mai. Ad un tratto poi mia madre
        ha intervenuto, facendomi sottoporre a dei test psicologici e
        ...
        la fisica. Poi mi é stato prescritto un farmaco, che si chiama Ritalin…
        Non é molto piacevole, perché si, ci si riesce a concentrarsi di più, e
        porta a un intervento nel resultato a scuola, o magari al lavoro. Peró
        al lavoro non mi servirà, e vi dirò il perché. Comunque torniamo un
        passo indietro. Per questo a scuola é stato riconosciuto come malattia,
        e a volte, durante le medie, avevo piú tempo per fare i test. Poi
        arrivavano le mamme di quelli con cui andavo a scuola, dei miei
        compagni: “Ma lui, ma cos’ha, non si vede, questa é una scusa, quá e lá”
        Non Potete dire questo! Quei medicinali li mi hanno fatto perdere dieci
        chili! Dieci chili in cinque anni! Cinque anni! Sapete una cosa: se uno
        ha l’ADHD, se lui una cosa la vuole, la raggiunge sempre. Perché siamo
        indeterminati, più emozionali e più impulsivi. Possiamo amare di più, ma
        ve lo giuro! Io ho amato come nessun’altra persona ha amato. E ve lo
        dico io, perché io le persone le vedo, parlo a loro, e a volte anche le
        sento. Perciò avere l’ADHD é una cosa bellissima. Alla gente che giudica
        la gente che ce l’ha: sappiate che non é facile viverci, però può essere
        anche un dono. Io ho imparato che non é facile viverci con questo però
        può essere anche un dono. Perció, a quelli che ce l’hanno: sappiate, non
        siete persi e, alla fine, quando avrete un lavoro, é grazie a questo che
        farete il doppio e di più degli altri, ve lo dico io, perché, io che
        sono un ADHD, se vorrei raggiungere una cosa la raggiungo molto prima di
        altri.” Vi dico la verità, io ne parlo con chiunque mi chieda, anche se
        potesse sembrare un discorso intimo, però non lo é. Io ne parlo molto
        volentieri con persone molto intime come per esempio, la mia ragazza, se
        ce l’avessi. Riguardo le mie compagne si, diciamo che, vi avevo detto,
        non é molto facile vivere con l’ADHD, perché nessuno lo capisce.
        <br />
        <br />
